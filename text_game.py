...
def get_user_input():
    ...
    while user_input not in valid_input:
        user_input = input("Invalid input. Please enter a valid move (N, S, E, W): ").upper()
    return user_input
...
def main():
    ...
    while True:
        ...
        if current_location == treasure_location:
            ...
            print(f"You've reached a new location, but the treasure is not here. Keep searching!\n")
